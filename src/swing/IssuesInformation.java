...
public class IssuesInformation extends javax.swing.JDialog {
   ...
   * @param modal
   */
  public IssuesInformation(java.awt.Frame parent, boolean modal) {
    super(parent, modal);
    initComponents();
  ...
  private void initComponents() {
    ...
    lblImg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/swing/resources/icon/icon_bug.png"))); // NOI18N

    jTextArea1.setEditable(false);
    jTextArea1.setColumns(20);
    jTextArea1.setLineWrap(true);
    jTextArea1.setRows(5);
    jTextArea1.setText("Hi! You seem to use Slyum a lot. Nice to see that! If you encounter some bugs or disagrements, feel free to report them from Help menu. Suggestions for enhancement are welcome too.\nTanks");
    ...
    layout.setHorizontalGroup(
      ...
      .addGroup(layout.createSequentialGroup()
        ...
        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
          ...
          .addGroup(layout.createSequentialGroup()
            .addComponent(jTextArea1, javax.swing.GroupLayout.PREFERRED_SIZE, 269, javax.swing.GroupLayout.PREFERRED_SIZE)
