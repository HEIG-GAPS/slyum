...
public class RelationPropreties extends GlobalPropreties
{
	...
	public RelationPropreties()
	{
		...
		final JPanel AssociationPanel = new JPanel();
		AssociationPanel.setBorder(new CompoundBorder(new MatteBorder(0, 0, 0, 2, new Color(0, 0, 0)), new EmptyBorder(10, 10, 10, 10)));
