...
public abstract class LineView extends GraphicComponent 
  ...
  /**
   * Get the nearest grip by the given grip. Specifically, return the next grip
   * in the array of grips, but if the given grip is the last, return the
   * previous grip.
   * 
   * @param grip
  ...
  /**
   * Get the previous grip in the array by the given grip or null if no grip are
   * found.
   * 
   * @param grip
   ...
   * line is almost vertical or horizontal, move the grip to make perfect line.
   * Use the SMOOTH_RATIO to change the ratio for say if the line must be moved
   * or not.
   */
