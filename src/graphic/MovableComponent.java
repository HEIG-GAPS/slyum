...
public abstract class MovableComponent extends GraphicComponent {
  ...
  /**
   * Compute the location of the resize. The offset define if it's the right or
   * the left resizer. The offset is add to the bounds.x location. The y
   * location is the middle bounds.y (bounds.y + bounds.heigth / 2)
   * 
   * @param offset
   *          value to add at the bounds.x location (0 for left, bounds.width
   *          for right).
  ...
  /**
   * Set a left resizer. A resizer is used to resizer graphic component bounds.
   * The left resizer resize the component from left.
   * 
   * @param left
   *          the new resizer.
   */
  ...
  /**
   * Set a right resizer. A resizer is used to resizer graphic component bounds.
   * The right resizer resize the component from right.
   * 
   * @param left
   *          the new resizer.
   */
