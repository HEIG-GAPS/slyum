...
public abstract class TextBoxLabel extends TextBox implements Observer {
   ...
   * component. If, for exemple, the label is x = 10 and y = 20 compared to its
   * component and this component moved, the label will compute it's location in
   * regard to the new component bounds but always with a movement of x = 10 and
   * y = 20.
   */
