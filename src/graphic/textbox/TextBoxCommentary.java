...
public class TextBoxCommentary extends MovableComponent implements ColoredComponent {
  ...
  /**
   * Create a new TextBoxCommentaray with the givent text associated with anoth
   * component. A TextBoxCommentary associated with a graphic component create a
   * new line between the note and the component. This line can be edited.
   * 
   * @param parent
