...
/**
 * Interface implemented by all listeners of class diagram. When the class diagram add, remove or change a new
 * component, it notify all listeners with the specified method.
 *
...
public interface IComponentsObserver {
  ...
  /**
   * Adds a new association class and notify that a new assocation class has been added.
   *
   * @param component the component that was added.
   */
  ...
  /**
   * Adds a new multi-association and notify that a new multi-association has been added.
   *
   * @param component the component that was added.
   */
  ...
  /**
   * Removes the given component and notify that this component has been removed.
   *
