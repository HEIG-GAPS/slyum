...
public enum Visibility {
  ...
  /**
   * Return the visibility corresponding to the car given in parameter or null if no visibility corresponding.
   *
   * @param car the car to find in visibility enum.
   *
   ...
   * @param car the car representing the visibility in UML.
   */
  ...
  /**
   * Get the car for this visibility. Car is the character representing the visibility in UML and can be + : PUBLIC - :
   * PRIVATE # : PROTECTED ~ : PACKAGE
   *
   * @return the {@link char} corresponding to the visibility.
   */
  public char toCar() {
    return car;
  }
