...
/**
 * This class contains all structurals UML components. Add classes, interfaces, associations, inheritances, dependecies
 * from here. It implements IComponentObserver and notify all listeners when a new UML components is added, removed or
 * modified.
 *
...
public class ClassDiagram extends Observable
   ...
   *
   * @param name the new name of class diagram.
   */
  @Override
   ...
   *
   * @param c the IComponentsObserver to remove
   *
  ...
  /**
   * Search the IDiagramComponent corresponding to the given id. Return null if no component are found.
   *
   * @param id id of the component to search
   *
   * @return the component corresponding to the given id, or null if no component are found.
   */
