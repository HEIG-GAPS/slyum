...
public class Dependency extends Observable implements Relation, ILabelTitle {
  ...
  /**
   * Create a new dependency with the given entities source and target. The source will be the entity depending on the
   * target.
   *
   * @param source the entity source - depending on target
   * @param target the entity target - the source depends
   */
  ...
  /**
   * Create a new dependency with the given entities source and target. The source will be the entity depending on the
   * target. Don't generate a new id and use this given in parameter.
   *
   * @param source the entity source - depending on target
   * @param target the entity target - the source depending.
   * @param id the identifier of the {@link Dependency}.
   */
  public Dependency(final Entity source, final Entity target, final int id) {
    init(source, target);
   ...
   *
   * @param source the source given in constructor
   * @param target the target given in constructor
   */
   ...
   *
   * @param source the new source for this dependency
   */
   ...
   *
   * @param target the new target for this dependency
   */
