...
/**
 * ClassFactory allows to create a new class view associated with a new class UML. Give this factory at the graphic view
 * using the method initNewComponent() for initialize a new factory. Next, graphic view will use the factory to allow
