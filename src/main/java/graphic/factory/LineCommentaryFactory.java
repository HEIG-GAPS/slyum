...
/**
 * LineCommentaryFactory allows to create a new line between a note and a graphic component. Give this factory at the
...
public class LineCommentaryFactory extends RelationFactory {
   ...
   */
  public LineCommentaryFactory(final GraphicView parent) {
    super(parent);
