...
/**
 * InheritanceFactory allows to create a new inheritance view associated with a new association UML. Give this factory
...
public class InheritanceFactory extends RelationFactory {
   ...
   */
  public InheritanceFactory(final GraphicView parent) {
    super(parent);
