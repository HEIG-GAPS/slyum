...
/**
 * NoteFactory allows to create a new note. Give this factory at the graphic view using the method initNewComponent()
 * for initialize a new factory. Next, graphic view will use the factory to allow creation of a new component, according
 * to the specificity of the factory.
 *
...
public class NoteFactory extends RelationFactory {
   ...
   */
  public NoteFactory(final GraphicView parent) {
    super(parent);
