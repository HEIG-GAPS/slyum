...
public class DependencyView extends RelationView {
   ...
   * @param dependency the dependency UML
   ...
   *
   * @param source the new source of the inheritance
   */
  public void setSource(EntityView source) {
    dependency.setSource((Entity) source.getAssociatedComponent());
  }

  /**
   * Set the target of the inheritance
   *
   * @param target the new target of the inheritance
   */
  public void setTarget(EntityView target) {
    dependency.setTarget((Entity) target.getAssociatedComponent());
  }
  ...
  public void restore() {
    ...
    if (this.getClass().equals(DependencyView.class))
      parent.getClassDiagram().addDependency((Dependency) getAssociatedComponent(), false);
