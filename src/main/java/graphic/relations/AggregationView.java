...
public class AggregationView extends BinaryView {
  ...
  public static void paintExtremity(final Graphics2D g2, final Point source, final Point target, final Color color,
    ...
    final int[] pointsX = new int[] {
        target.x, (int) ref.getX() + vectorXN1, (int) ref2.getX(),
   ...
   * @param aggregation the aggregation UML
  ...
  public void restore() {
    super.restore();
    parent.getClassDiagram().addAggregation((Aggregation) getAssociatedComponent(), false);
