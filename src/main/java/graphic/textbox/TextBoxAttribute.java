 ...
 * <p>
 * A TextBoxAttribute is a TextBox displaying an Attribute (UML). When editing the text, this TextBox parse the String
 * to change it into an Attribute. It listening Attribute changes for auto-update itself.
 *
...
public class TextBoxAttribute extends TextBox implements Observer {
   ...
   *
   * @param attribute the attribute to convert to String
   *
