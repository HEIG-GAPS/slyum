...
/**
 * This class is the main container for all diagrams components view (classComponent, interfaceComponent, relation,
 * ...). It performs class diagram, movables and resizables events. Each graphic component have a reference on the
 * graphic view.
 *
...
public class GraphicView extends GraphicComponent
  ...
  /**
   * Compute mouse entered and exited event. the componentMouseHover can be the same as the current component. In this
   * case, no event will be called.
   *
  ...
  /**
   * Get the basic color for the graphic view. The basic color is the color define by default for new graphic view.
   *
   * @return the basic {@link Color}.
   */
  ...
  /**
   * Set a new basic color for graphic views. The basic color is the color define by default for new graphic view.
   *
   * @param color the {@link Color}.
   */
  public static void setBasicColor(final Color color) {
    PropertyLoader
        .getInstance()
        .getProperties()
  ...
  /**
   * Search a component in the given who are on the location given. This method uses the isAtPosition() method from
   * GraphicComponent for know if the location given is on the component or not. Return null if no component are found.
   * This method return the first component found in
   *
   * @param <T> the list.
   * @param components the list of component extent from GraphicComponent
   * @param pos the location for find a component
   *
  ...
  /**
   * Create a new graphic view representing the class diagram given. The new graphic view is empty when created. If
   * classDiagram given is not empty, you must manually add existing component.
   *
   * @param classDiagram the class diagram associated with this graphic view.
  ...
  /**
   * Add a new entity view. Adding a component means it will be drawn and managed by the graphic view.
   *
  ...
  /**
   * Add a new line view. Adding a component means it will be drawn and managed by the graphic view.
   *
  ...
  /**
   * Add a new multi line view. Adding a component means it will be drawn and managed by the graphic view.
   *
   * @param component the multi line to add.
   *
   * @return true if the component has been added; false otherwise
   */
  ...
  /**
   * Add a new note. Adding a component means it will be drawn and managed by the graphic view.
   *
   * @param component the note to add.
   *
   * @return true if the component has been added; false otherwise
   */
  ...
  /**
   * Add a new graphic component. Adding a component means it will be drawn and managed by the graphic view.
   *
   * @param component the new graphic component to add.
   *
   * @return true if the component has been added; false otherwise
   */
  ...
  /**
   * Get entities contents in this graphic view and adjust their width. See adjustWidth() method from EntityView.
   *
  ...
  /**
   * Get all entities contents in this graphic view and adjust their width. See adjustWidth() method from EntityView.
   */
  ...
  /**
   * Get all selected entities contents in this graphic view and adjust their width. See adjustWidth() method from
   * EntityView.
   */
  ...
  /**
   * Align all selected entities with the hightest or lowest selected entity. Make same space between all selected
   * entities.
   *
  ...
  /**
   * Align all selected entities with the leftmost or rightmost selected entity. Make same space between all selected
   * entities.
   *
   * @param left {@code true} to align to the left or {@code false} to align to the right.
   */
  public void alignVertical(final boolean left) {
    boolean isRecord = Change.isRecord();
    Change.record();
  ...
  /**
   * Change the size of the police. It is the responsibility of graphic component to consider the new size or not. The
   * police size is compute with the actuel size * zoom. By default zoom is at 1.0f, adding a new grow will add the zoom
   * coefficient (zoom + grow).
   *
   * @param grow new value for zoom. A grow positive will make the police size greater, a negativ grow make the police
   * smaller.
   */
  ...
  /**
   * Hide the rubber band, compute components who was in rubber band and select them.
   *
  ...
  public GraphicComponent createAndAddRelation(
    ...
    if (relation.getClass() == Multi.class) {
      if (((Multi) relation).getRoles().stream().filter(r -> searchAssociedComponent(r.getEntity()) != null).count() >
          2) {
  ...
  public void duplicateSelectedEntities() {
    ...
    for (final EntityView entityView : getSelectedEntities()) {
      try {
        ...
        Entity entity = ((Entity) newView.getAssociatedComponent());
  ...
  public LinkedList<GraphicComponent> getAllComponentsAssociated() {
    ...
    for (GraphicComponent gc : getAllComponents())
      if (gc.getAssociatedComponent() != null)
        components.add(gc);
    return components;
  }
  ...
  /**
   * Return all mains components. Mains components are associations and entities.
   *
  ...
  /**
   * Get all unique graphics components having a diagram component associated with. A unique graphic component is a
   * component that exist only in this view.
   *
   * @return a list of all graphic component having a diagram component.
   */
  ...
  /**
   * Search a component in the graphic view who are at the given location. Return the graphic view if no component are
   * found.
   *
   * @param pos the location for find a component
   *
   * @return the component at the location; or the graphic view if no component are at this location
   */
  ...
  /**
   * Same as searchComponentWithPosition(), but inverse the order of graphic components.
   *
   * @param <T> the specific type for the component.
   * @param list the list where find component
   * @param pos the location for find graphic components
   *
   * @return the component found; or null if no component are found.
   */
  public <T extends GraphicComponent> T getComponentListAtPosition(final LinkedList<T> list, final Point pos) {
   ...
   *
   * @param component the new pressed component
   */
  ...
  /**
   * Same as getComponentListAtPosition(), but search only diagram elements (include entities, relations and notes). See
   * getDiagramElements for know arrays used. This method permit to define a component we will not find.
   *
   * @param pos the location for find diagram components
   * @param except remove this component from arrays and no longer be found
   *
   * @return the component found or null if no component are found
   */
  ...
  /**
   * Get all diagram elements contains in the graphic view. Diagram elements are : - Lines views - Entities views -
   * Multi views - Notes views
   *
   ...
   *
   * @param pos the location of entity to find
   *
   ...
   *
   * @param pos the location of line view to find
   *
  ...
  /**
   * Search all relations associated with the given graphic component. An associated relation is an association who have
   * at one or more extremities the graphic component given.
   *
   * @param component the component to find its relations
   *
   * @return an array containing all relations associated with the given component
   */
  ...
  /**
   * Make a picture (BufferedImage) representing the scene. Call refreshAllComponents before calling this method and
   * then call it with SwingUtilites.invokeLater.
   *
  ...
  /**
   * Set the font zoom. The zoom is multiplied with the font size for computing new size. Default value : 1.0f.
   *
  ...
  /**
   * Redirect all mouse event to the factory given and draw the factory. A factory is use for creating new graphic
   * component. For remove a current factory, calls deleteCurrentFactory().
   *
  ...
  /**
   * Notify obsevers of all components. This will replace and recalculate all component's location to fit at their
   * correct location.
   */
  ...
  /**
   * Remove the given component from graphic view. Remove the associed UML component too (if exists).
   *
  ...
  /**
   * Search a graphic component associated with the object given. Some graphic component have an UML component
   * associated. Return null if no component are associated.
   *
   * @param search the object associated with a graphic component
   *
   * @return the graphic component associated with the given object; or null if no graphic component are found
   */
  public GraphicComponent searchAssociedComponent(Object search) {
    if (search == null) return null;

    for (final GraphicComponent c : getAllComponents())
      if (c.getAssociatedComponent() == search)
        return c;
   ...
   *
   * @param show true for showing attributes, false otherwise
   */
   ...
   *
   * @param show true for showing methods, false otherwise
   */
  ...
  /**
   * Sort the given list by x location. The first element of the list will be the leftmost component in graphicview.
   *
   * @param list the lost to sort
   *
   * @return the list sorted
   */
  public LinkedList<EntityView> sortXLocation(LinkedList<EntityView> list) {
    @SuppressWarnings("unchecked") final LinkedList<EntityView> cpyList = (LinkedList<EntityView>) list
        .clone();
  ...
  /**
   * Sort the given list by y location. The first element of the list will be the hightest component in graphicview.
   *
   * @param list the lost to sort
   *
   * @return the list sorted
  ...
  /**
   * Compute a new preferred size for the scrollPane. Calls when graphic component is resized or moved.
   */
  ...
  /**
   * Paint the background with the specified color. A point grid is drawing with space specified by gridSize.
   *
  ...
  /**
   * Clear and repaint the rubber band with the new bounds compute from Points given in parameters.
   *
   * @param origin where the user clicked for make a rubber band
  ...
  public boolean addEntityWithRelations(final EntityView entityView, final Point location) {
    ...
    GraphicComponent component = searchAssociedComponent(entityView.getAssociatedComponent());
    if (component != null) {
      SMessageDialog.showErrorMessage(
          "The entity " + ((Entity) entityView.getAssociatedComponent()).getName() +
    ...
    Entity entity1 = (Entity) entityView.getAssociatedComponent();
