...
public class Multiplicity extends Observable implements IDiagramComponent {
  ...
  /**
   * Create a new multiplicity with a lower bound equals to upper bounds. It is
   ...
   * bound can't be greater than upper bounds. Upper bound and lower bound must
  ...
  /**
   * Convert the lower bound in a character. Every bounds are converted in this
   * equivalent in string and infinite (define by the value Integer.MAX_VALUE)
  ...
  /**
   * Convert the upper bound in a character. Every bounds are converted in this
   * equivalent in string and infinite (define by the value Integer.MAX_VALUE)
   * is represented by the car '*'.
   * 
