...
public class RelationChanger {
   ...
   * @param source is the source or the target who need to be update?
   * @param target the new Entity to be changed.
   * @return if the change were successful.
   */
  public static void changeRelation(
      Relation relation, boolean source, Entity target) {
    if (source)
   ...
   * @return if the change were successful.
   */
  public static void changeAssociation(
      Association association, Role source, Role target) {
