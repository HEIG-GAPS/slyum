...
public class AssociationClass extends ClassEntity {
   ...
   * Construct a new association class. An association class is a class in UML
   * structure associated with an association. Does not construct a new binary
   * association but will use the binary given in parameters. Does not generate
   * a new unique id but will use the id given in parameters.
   * 
   * @param name
   *          the name of the class
   * @param visibility
  ...
  /**
   * Construct a new association class. An association class is a class in UML
   * structure associated with an association. A new binary association will be
   * created between the given source and target.
   * 
   * @param name
   *          the name of the class
   * @param visibility
