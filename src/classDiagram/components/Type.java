...
public class Type extends Observable implements IDiagramComponent {
  ...
  private final static String REGEXP_GENERIC = Variable.REGEX_SEMANTIC_ATTRIBUTE
          + "(<("
  ...
  /**
   * Return the number of dimension of this type, or 0 if the type doesn't
   * represent an array.
   * 
   * @return the number of dimension of this type, or 0 if the type doesn't
   *         represent an array.
  ...
  /**
   * Return a LinkedList containing the size of the dimensions in the array. If
   * the LinkedList is empty, that means this type doesn't represent an array.
   * The number -1 means the size is left blank (only possible in last
   * dimension).
   * 
