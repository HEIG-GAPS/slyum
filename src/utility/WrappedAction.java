 ...
 * using this class: a) Key Bindings of the original Action are retained for the
 * custom Action. b) the original Action is retained so your custom Action can
 * invoke the original Action. This class is abstract so your custom Action must
 * extend this class and implement the actionPerformed() method. */
abstract class WrappedAction implements Action {
  ...
  /* Replace the existing Action for the given action key with a wrapped custom
   * Action */
